# GitHub Copilot Snippet for openapi-operator-gen

Copy the section below into your project's `.github/copilot-instructions.md` file
(create it if it doesn't exist). Replace the placeholder values in `[BRACKETS]`
with your project-specific values.

If you have the MCP server configured (`openapi-operator-gen setup copilot`),
Copilot can use the validate/preview/generate tools directly and this snippet is
