...
// isClientGoFlag returns true if the flag name is a standard client-go
// persistent flag (e.g., --server, --token, --insecure-skip-tls-verify).
// Used by parameter parsers to exclude connection flags from spec parameters.
func isClientGoFlag(name string) bool {
	clientGoFlags := map[string]bool{
		"server": true, "s": true,
		"token": true,
