...
var (
	// CompactMode outputs JSON without indentation (single-line).
	// Set via --compact flag. Required for Rundeck json-mapper log filter parsing.
	CompactMode bool
...
// When CompactMode is true, outputs single-line JSON for log filter parsing.
