...
func reconcileUserLogoutQueryUntilComplete(
	t *testing.T,
	ctx context.Context,
	reconciler *UserLogoutQueryReconciler,
	req ctrl.Request,
	maxIterations int,
...
func TestUserLogoutQueryReconciler_E2E(t *testing.T) {
	// Setup scheme
	...
	result, err, iterations := reconcileUserLogoutQueryUntilComplete(t, ctx, reconciler, req, 10)
	...
	var updated v1alpha1.UserLogoutQuery
	if err := fakeClient.Get(ctx, types.NamespacedName{Name: "test-userlogoutquery", Namespace: "default"}, &updated); err != nil {
...
func TestUserLogoutQueryReconciler_RequeueBehavior(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestUserLogoutQueryReconciler_CreateResource(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcileUserLogoutQueryUntilComplete(t, ctx, reconciler, req, 10)
...
func TestUserLogoutQueryReconciler_HTTPNotFound(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcileUserLogoutQueryUntilComplete(t, ctx, reconciler, req, 5)
...
func TestUserLogoutQueryReconciler_HTTPServerError(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	result, err, iterations := reconcileUserLogoutQueryUntilComplete(t, ctx, reconciler, req, 3)
...
func TestUserLogoutQueryReconciler_HTTPUnauthorized(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcileUserLogoutQueryUntilComplete(t, ctx, reconciler, req, 3)
...
func TestUserLogoutQueryReconciler_HTTPRateLimited(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcileUserLogoutQueryUntilComplete(t, ctx, reconciler, req, 5)
...
func TestUserLogoutQueryReconciler_HTTPInvalidJSON(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestUserLogoutQueryReconciler_HTTPTimeout(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
// httpRequestUserLogoutQuery captures details of an HTTP request for test validation
type httpRequestUserLogoutQuery struct {
	Method string
	URL    string
	Body   map[string]interface{}
}

// TestUserLogoutQueryReconciler_URLAndResponseConsistency verifies that:
...
func TestUserLogoutQueryReconciler_URLAndResponseConsistency(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	var receivedRequests []httpRequestUserLogoutQuery
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		receivedRequests = append(receivedRequests, httpRequestUserLogoutQuery{
			Method: r.Method,
			URL:    fullURL,
			Body:   bodyMap,
		})
