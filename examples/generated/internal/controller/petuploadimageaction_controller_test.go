...
func reconcilePetUploadimageActionUntilComplete(
	t *testing.T,
	ctx context.Context,
	reconciler *PetUploadimageActionReconciler,
	req ctrl.Request,
	maxIterations int,
...
func TestPetUploadimageActionReconciler_E2E(t *testing.T) {
	// Setup scheme
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case http.MethodPut:
			...
			json.NewEncoder(w).Encode(map[string]interface{}{
				"id":   123,
				"name": "UpdatedPetUploadimageAction",
			})
	...
	// Create test CR
	obj := &v1alpha1.PetUploadimageAction{
	...
	result, err, iterations := reconcilePetUploadimageActionUntilComplete(t, ctx, reconciler, req, 10)
	...
	var updated v1alpha1.PetUploadimageAction
	if err := fakeClient.Get(ctx, types.NamespacedName{Name: "test-petuploadimageaction", Namespace: "default"}, &updated); err != nil {
...
func TestPetUploadimageActionReconciler_RequeueBehavior(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestPetUploadimageActionReconciler_CreateResource(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcilePetUploadimageActionUntilComplete(t, ctx, reconciler, req, 10)
...
func TestPetUploadimageActionReconciler_HTTPNotFound(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcilePetUploadimageActionUntilComplete(t, ctx, reconciler, req, 5)
...
func TestPetUploadimageActionReconciler_HTTPServerError(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	result, err, iterations := reconcilePetUploadimageActionUntilComplete(t, ctx, reconciler, req, 3)
...
func TestPetUploadimageActionReconciler_HTTPUnauthorized(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcilePetUploadimageActionUntilComplete(t, ctx, reconciler, req, 3)
...
func TestPetUploadimageActionReconciler_HTTPRateLimited(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcilePetUploadimageActionUntilComplete(t, ctx, reconciler, req, 5)
...
func TestPetUploadimageActionReconciler_HTTPInvalidJSON(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestPetUploadimageActionReconciler_HTTPTimeout(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
// httpRequestPetUploadimageAction captures details of an HTTP request for test validation
type httpRequestPetUploadimageAction struct {
	Method string
	URL    string
	Body   map[string]interface{}
}

// TestPetUploadimageActionReconciler_URLAndResponseConsistency verifies that:
...
func TestPetUploadimageActionReconciler_URLAndResponseConsistency(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		receivedRequests = append(receivedRequests, httpRequestPetUploadimageAction{
			Method: r.Method,
			URL:    fullURL,
			Body:   bodyMap,
		})
