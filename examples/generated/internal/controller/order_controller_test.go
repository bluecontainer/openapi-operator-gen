...
func reconcileOrderUntilComplete(
	t *testing.T,
	ctx context.Context,
...
func TestOrderReconciler_E2E(t *testing.T) {
	// Setup scheme
	...
	result, err, iterations := reconcileOrderUntilComplete(t, ctx, reconciler, req, 10)
	...
	var updated v1alpha1.Order
	if err := fakeClient.Get(ctx, types.NamespacedName{Name: "test-order", Namespace: "default"}, &updated); err != nil {
...
func TestOrderReconciler_RequeueBehavior(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestOrderReconciler_CreateResource(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcileOrderUntilComplete(t, ctx, reconciler, req, 10)
...
func TestOrderReconciler_HTTPNotFound(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcileOrderUntilComplete(t, ctx, reconciler, req, 5)
...
func TestOrderReconciler_HTTPServerError(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	result, err, iterations := reconcileOrderUntilComplete(t, ctx, reconciler, req, 3)
...
func TestOrderReconciler_HTTPUnauthorized(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcileOrderUntilComplete(t, ctx, reconciler, req, 3)
...
func TestOrderReconciler_HTTPRateLimited(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcileOrderUntilComplete(t, ctx, reconciler, req, 5)
...
func TestOrderReconciler_HTTPInvalidJSON(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestOrderReconciler_HTTPTimeout(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
// httpRequestOrder captures details of an HTTP request for test validation
type httpRequestOrder struct {
	Method string
	URL    string
	Body   map[string]interface{}
}

// TestOrderReconciler_URLAndResponseConsistency verifies that:
...
func TestOrderReconciler_URLAndResponseConsistency(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	var receivedRequests []httpRequestOrder
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		receivedRequests = append(receivedRequests, httpRequestOrder{
			Method: r.Method,
			URL:    fullURL,
			Body:   bodyMap,
		})
