...
func reconcileUserUntilComplete(
	t *testing.T,
	ctx context.Context,
...
func TestUserReconciler_E2E(t *testing.T) {
	// Setup scheme
	...
	result, err, iterations := reconcileUserUntilComplete(t, ctx, reconciler, req, 10)
	...
	if err := fakeClient.Get(ctx, types.NamespacedName{Name: "test-user", Namespace: "default"}, &updated); err != nil {
...
func TestUserReconciler_RequeueBehavior(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestUserReconciler_CreateResource(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcileUserUntilComplete(t, ctx, reconciler, req, 10)
...
func TestUserReconciler_HTTPNotFound(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcileUserUntilComplete(t, ctx, reconciler, req, 5)
...
func TestUserReconciler_HTTPServerError(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	result, err, iterations := reconcileUserUntilComplete(t, ctx, reconciler, req, 3)
...
func TestUserReconciler_HTTPUnauthorized(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcileUserUntilComplete(t, ctx, reconciler, req, 3)
...
func TestUserReconciler_HTTPRateLimited(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcileUserUntilComplete(t, ctx, reconciler, req, 5)
...
func TestUserReconciler_HTTPInvalidJSON(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestUserReconciler_HTTPTimeout(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
// httpRequestUser captures details of an HTTP request for test validation
type httpRequestUser struct {
	Method string
	URL    string
	Body   map[string]interface{}
}

// TestUserReconciler_URLAndResponseConsistency verifies that:
...
func TestUserReconciler_URLAndResponseConsistency(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	var receivedRequests []httpRequestUser
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		receivedRequests = append(receivedRequests, httpRequestUser{
			Method: r.Method,
			URL:    fullURL,
			Body:   bodyMap,
		})
...
// TestUserReconciler_PathParamInURL verifies that path parameters from spec
// are correctly substituted in the HTTP request URL
func TestUserReconciler_PathParamInURL(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
