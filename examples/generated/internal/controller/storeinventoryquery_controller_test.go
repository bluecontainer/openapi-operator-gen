...
func reconcileStoreInventoryQueryUntilComplete(
	t *testing.T,
	ctx context.Context,
	reconciler *StoreInventoryQueryReconciler,
	req ctrl.Request,
	maxIterations int,
...
func TestStoreInventoryQueryReconciler_E2E(t *testing.T) {
	// Setup scheme
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case http.MethodPut:
			...
			json.NewEncoder(w).Encode(map[string]interface{}{
				"id":   123,
				"name": "UpdatedStoreInventoryQuery",
			})
	...
	// Create test CR
	obj := &v1alpha1.StoreInventoryQuery{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "test-storeinventoryquery",
			Namespace: "default",
		},
	...
	result, err, iterations := reconcileStoreInventoryQueryUntilComplete(t, ctx, reconciler, req, 10)
	...
	var updated v1alpha1.StoreInventoryQuery
	if err := fakeClient.Get(ctx, types.NamespacedName{Name: "test-storeinventoryquery", Namespace: "default"}, &updated); err != nil {
...
func TestStoreInventoryQueryReconciler_RequeueBehavior(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestStoreInventoryQueryReconciler_CreateResource(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcileStoreInventoryQueryUntilComplete(t, ctx, reconciler, req, 10)
...
func TestStoreInventoryQueryReconciler_HTTPNotFound(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcileStoreInventoryQueryUntilComplete(t, ctx, reconciler, req, 5)
...
func TestStoreInventoryQueryReconciler_HTTPServerError(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	result, err, iterations := reconcileStoreInventoryQueryUntilComplete(t, ctx, reconciler, req, 3)
...
func TestStoreInventoryQueryReconciler_HTTPUnauthorized(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, _ := reconcileStoreInventoryQueryUntilComplete(t, ctx, reconciler, req, 3)
...
func TestStoreInventoryQueryReconciler_HTTPRateLimited(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	_, err, iterations := reconcileStoreInventoryQueryUntilComplete(t, ctx, reconciler, req, 5)
...
func TestStoreInventoryQueryReconciler_HTTPInvalidJSON(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
func TestStoreInventoryQueryReconciler_HTTPTimeout(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
...
// httpRequestStoreInventoryQuery captures details of an HTTP request for test validation
type httpRequestStoreInventoryQuery struct {
	Method string
	URL    string
	Body   map[string]interface{}
}

// TestStoreInventoryQueryReconciler_URLAndResponseConsistency verifies that:
...
func TestStoreInventoryQueryReconciler_URLAndResponseConsistency(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	var receivedRequests []httpRequestStoreInventoryQuery
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		receivedRequests = append(receivedRequests, httpRequestStoreInventoryQuery{
			Method: r.Method,
			URL:    fullURL,
			Body:   bodyMap,
		})
...
// TestStoreInventoryQueryReconciler_QueryParams verifies that query parameters from spec
// are correctly appended to the HTTP request URL
func TestStoreInventoryQueryReconciler_QueryParams(t *testing.T) {
	scheme := runtime.NewScheme()
	_ = clientgoscheme.AddToScheme(scheme)
	_ = v1alpha1.AddToScheme(scheme)
	...
	expectedQueryPath := "/store/inventory"
