...
- `pkg/endpoint/` - **Shared library** imported by generated operators for runtime endpoint discovery (StatefulSet/Deployment/DaemonSet/Helm release discovery, strategy selection, health checking)
